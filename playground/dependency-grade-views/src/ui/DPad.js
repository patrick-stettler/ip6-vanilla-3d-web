 ...
 * @property {!function(): void}  reset     - called once when the center button is clicked. Mandatory.
 */
...
/**
 * Creates the center button: a single click (not hold-to-repeat, unlike the
 * directional buttons) that resets the camera view.
...
/**
 * Creates a labelled 4-direction D-pad widget for continuous scene
 * navigation, plus a center button that resets the view.
 ...
 *       reset: () => viewModeController.resetView(),
 *     }));
 */
